...
**nf-core/atacseq** is a bioinformatics pipeline that ...
...
nf-core/atacseq was originally written by Patel H, Langer B, Espinosa-Carrasco J, Syme R.
...
<!-- If you use nf-core/atacseq for your analysis, please cite it using the following doi: [10.5281/zenodo.XXXXXX](https://doi.org/10.5281/zenodo.XXXXXX) --><!-- TODO nf-core: Add bibliography of tools and data used in your pipeline -->
